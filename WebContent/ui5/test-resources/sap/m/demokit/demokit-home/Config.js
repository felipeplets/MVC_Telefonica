...
Config.data = {
	apps : [
		...
		},
		{
			...
			info : "Helps you in finding icons out of a built-in set of almost 500 icons",
			paths : [
				{
					group : 1,
					name : "Phone",
		...
		},
		{
			name : "Shopping Cart",
			icon : "custom/cart",
			info : "The classical business process of finding & ordering products",
			paths : [
				{
					group : 1,
					name : "Phone",
		...
		},
		{
			name : "MaKit",
			icon : "custom/makit",
			info : "Shows you how to create business charts with the MaKit control",
			paths : [
				{
					group : 1,
					name : "Tablet",
		...
		},
		{
			...
			info : "This is where it all starts when developing with sap.m",
			paths : [
				{
					group : 1,
					name : "Phone",
		...
		},
		{
			name : "CRUD Patterns",
			icon : "custom/crud",
			info : "A design best practice for CRUD patterns on the phone",
			paths : [
				{
					group : 1,
					name : "Phone",
